...
def state0():
    ...
    timeline[0][11] = 0     #RMD
    timeline[0][12] = anu_av    #Annuity Acount Value
    timeline[0][13] = 0     #Annuity Payment
...
##        act_ret = random.gauss(avg_ret, sd_ret)
        ...
        if my_date > anu_st_pmt:
            timeline[row_cnt][13] = 0.0475*timeline[row_cnt-1][12]
        timeline[row_cnt][12] = (timeline[row_cnt-1][12] - timeline[row_cnt][13])*(1+act_ret)
        if act_ret < anu_gar:
            timeline[row_cnt][12] = (timeline[row_cnt-1][12] - timeline[row_cnt][13])*(1+anu_gar)
...
##    jjd = delta_time.days/365.25
    ...
    if my_date > anu_st_pmt:
        timeline[row_cnt][13] = 0.0475*timeline[row_cnt-1][12]*delta_time.days/365.25
    timeline[row_cnt][12] = (timeline[row_cnt-1][12] - timeline[row_cnt][13])*((1+act_ret)**(delta_time.days/365.25))
    if act_ret < anu_gar:
        timeline[row_cnt][12] = (timeline[row_cnt-1][12] - timeline[row_cnt][13])*((1+anu_gar)**(delta_time.days/365.25))
...
##    act_ret = random.gauss(avg_ret, sd_ret)
    ...
    timeline[row_cnt][11] = 0       #RMD
    if my_date > anu_st_pmt:
        timeline[row_cnt][13] = 0.0475*timeline[row_cnt-1][12]*frac_time.days/365.25
    timeline[row_cnt][12] = (timeline[row_cnt-1][12] - timeline[row_cnt][13])*((1+act_ret)**(frac_time.days/365.25))
    if act_ret < anu_gar:
        timeline[row_cnt][12] = (timeline[row_cnt-1][12] - timeline[row_cnt][13])*(1+anu_gar)*((1+act_ret)**(frac_time.days/365.25))
...
def state2(row_cnt):
    ...
    expenses = proj_exp*cum_cpi - timeline[row_cnt-1][13]
...
##        act_ret = random.gauss(avg_ret, sd_ret)
        ...
        taxes = calc_taxes(timeline[row_cnt-1][2] * act_ret + timeline[row_cnt-1][13])
        timeline[row_cnt][0] = my_date
...
##            back_add_taxes = timeline[row_cnt][1] + timeline[row_cnt][2] + taxes
            taxes = calc_taxes(expenses + timeline[row_cnt - 1][13] + timeline[row_cnt - 1][7] + health_care + liabilities)
...
##            timeline[row_cnt][6] = expenses     #Q Taxable Income
            timeline[row_cnt][6] = expenses + timeline[row_cnt - 1][13] + timeline[row_cnt - 1][7] + health_care + liabilities
            timeline[row_cnt][7] = taxes      #Taxes
            timeline[row_cnt][8] = health_care      #Healthcare
            timeline[row_cnt][10] = timeline[row_cnt][4] + timeline[row_cnt][7] + timeline[row_cnt][8]
            timeline[row_cnt][11] - 0       #RMD
        ...
        my_date = my_date + datetime.timedelta(days = 365.25)
        delta_time = my_date - start_date
        expenses = expenses*(1+act_cpi) - timeline[row_cnt-1][13]
...
def state3(row_cnt):
    ...
    for i in range(ret_index + 1):
        cum_cpi = cum_cpi * (1 + cpi_list[i] [mc_cnt])
        cum_hc_cpi = cum_hc_cpi*(1.04 + cpi_list[i] [mc_cnt])
    expenses = proj_exp*cum_cpi - timeline[row_cnt-1][13]  # initial expenses
    health_care = hc*cum_hc_cpi
...
##        act_ret = random.gauss(avg_ret, sd_ret)
        ...
        taxes = calc_taxes(timeline[row_cnt-1][2] * act_ret + ss_income*0.85 + timeline[row_cnt-1][13])
        timeline[row_cnt][0] = my_date
        timeline[row_cnt][1] = timeline[row_cnt-1][1]*(1+act_ret) + 0 + 0
        ...
        if my_date > anu_st_pmt:
            timeline[row_cnt][13] = 0.0475*timeline[row_cnt-1][12]
        if my_date > anu_fix:
            timeline[row_cnt][13] = timeline[row_cnt-1][13]
        timeline[row_cnt][12] = (timeline[row_cnt-1][12] - timeline[row_cnt][13])*(1+act_ret)
        if act_ret < anu_gar:
            timeline[row_cnt][12] = (timeline[row_cnt-1][12] - timeline[row_cnt][13])*(1+anu_gar)
        ...
        if timeline[row_cnt][2] < 0:
##            back_add_taxes = timeline[row_cnt][1] + timeline[row_cnt][2] + taxes
            taxes = calc_taxes(expenses + timeline[row_cnt-1][13] + timeline[row_cnt - 1][7] + health_care + liabilities- ss_income + ss_income*0.85)
...
##            timeline[row_cnt][6] = expenses - ss_income*0.15      #Q Taxable Income
            timeline[row_cnt][6] = expenses + timeline[row_cnt-1][13] + timeline[row_cnt - 1][7] + health_care + liabilities- ss_income + ss_income*0.85
            timeline[row_cnt][7] = taxes      #Taxes
            timeline[row_cnt][8] = health_care      #Healthcare
            timeline[row_cnt][10] = timeline[row_cnt][4] + timeline[row_cnt][7] + timeline[row_cnt][8]
            timeline[row_cnt][11] = 0       #RMD
        expenses = proj_exp*cum_cpi - timeline[row_cnt][13]
        health_care = health_care*(1.04+act_cpi)
        row_cnt = row_cnt + 1
        my_date = my_date + datetime.timedelta(days = 365.25)
...
##            return(row_cnt + 1)
    ...
    taxes = calc_taxes(timeline[row_cnt-1][2] * act_ret + timeline[row_cnt][13])
...
##    act_ret = random.gauss(avg_ret, sd_ret)
    ...
    if my_date > anu_st_pmt:
        timeline[row_cnt][13] = 0.0475*timeline[row_cnt-1][12]*frac_time.days/365.25
    if my_date > anu_fix:
        timeline[row_cnt][13] = timeline[row_cnt-1][13]*frac_time.days/365.25
    timeline[row_cnt][12] = (timeline[row_cnt-1][12] - timeline[row_cnt][13]*frac_time.days/365.25)*(1+act_ret)
    if act_ret < anu_gar:
        timeline[row_cnt][12] = (timeline[row_cnt-1][12] - timeline[row_cnt][13]*frac_time.days/365.25)*(1+anu_gar)
...
def state4(row_cnt):
    ...
    while my_date <= state4_end:
        ...
        if my_date > anu_st_pmt:
            timeline[row_cnt][13] = 0.0475*timeline[row_cnt-1][12]
        if my_date > anu_fix:
            if timeline[row_cnt-1][0] > timeline[row_cnt-2][0] + datetime.timedelta(days=360):
                timeline[row_cnt][13] = timeline[row_cnt-1][13]
            else:
                timeline[row_cnt][13] = 0.0475*timeline[row_cnt-1][12]
...
if __name__ == '__main__':
    ...
    timeline = [[0 for j in range(14)] for i in range(50)]
    header = [[0 for j in range(14)] for i in range(1)]
...
##                res_f.write(row)
                ...
                if onheader == 0:
                    ...
                    anu_av = float(row[23].replace("$","").replace(",",""))
                    anu_st_pmt = parse(row[24])
                    anu_fix = parse(row[25])
                    anu_gar = float(row[26].strip('%'))/100
...
##                            act_ret = random.gauss(avg_ret, sd_ret)
                    ...
                    header[0][11] = "RMD"
                    header[0][12] = "Annuity AV"
                    header[0][13] = "Annuity Pmt"
