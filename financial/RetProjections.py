...
def calc_taxes(taxable):
    ...
    if taxable > 231450:
        taxes += (min(taxable - 231450)-231450)*0.33
...
def state3(row_cnt):
    ...
    while my_date <= state3_end:
        ...
        if timeline[row_cnt][2] < 0:
            ...
            timeline[row_cnt][1] = back_add_taxes - taxes
...
if __name__ == '__main__':
    ...
    timeline = [[0 for j in range(9)] for i in range(50)]
    header = [[0 for j in range(9)] for i in range(1)]
    plt.ion()
    plt_type = "B"
...
##                res_f.write(row)
                ...
                if onheader == 0:
                    ...
                    worst_end = copy(nom_tl[next_row - 1][1])
                    fails = 0
                    passes = 0
...
##                            act_ret = random.gauss(avg_ret, sd_ret)
                            ...
                            if timeline[next_row - 1][1] < worst_end:
                                worst_tl = deepcopy(timeline)
                                worst_end = copy(timeline[next_row - 1][1])
                        ...
                        title_str = trial + ' Confidence = ' + str(float(passes)/10) +'%'
