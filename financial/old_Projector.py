...
def state0():
    ...
    timeline[0][1] = timeline[0][0] - jon_bd
    timeline[0][2] = qual_tot
    timeline[0][3] = nonq_tot
    timeline[0][4] = 0      #SS income
    timeline[0][5] = 0      #Expenses
    timeline[0][6] = 0      #NQ Taxable Income
    timeline[0][7] = 0      #Q Taxable Income
    timeline[0][8] = 0      #Taxes
    timeline[0][9] = 0      #Healthcare
    timeline[0][10] = timeline[0][5] = timeline[0][8] = timeline[0][9]      # total expenses
...
##        act_ret = random.gauss(avg_ret, sd_ret)
        ...
        timeline[row_cnt][1] = timeline[row_cnt][0] - jon_bd
        timeline[row_cnt][2] = timeline[row_cnt-1][1]*(1+act_ret) + (cont_403b + cont_401k)*((1+cpi)**(delta_time.days/365.25))
        timeline[row_cnt][3] = timeline[row_cnt-1][2]*(1+act_ret) + (cont_espp + cont_rsu)*((1+cpi)**(delta_time.days/365.25))
        timeline[row_cnt][4] = 0      #SS income
        timeline[row_cnt][5] = 0      #Expenses
        timeline[row_cnt][6] = 0      #NQ Taxable Income
        timeline[row_cnt][7] = 0      #Q Taxable Income
        timeline[row_cnt][8] = 0      #Taxes
        timeline[row_cnt][9] = 0      #Healthcare
        row_cnt = row_cnt + 1
...
##    jjd = delta_time.days/365.25
    timeline[row_cnt][2] = timeline[row_cnt-1][1]*((1+act_ret)**(delta_time.days/365.25)) + (cont_403b + cont_401k)*delta_time.days/365.25
    timeline[row_cnt][3] = timeline[row_cnt-1][2]*((1+act_ret)**(delta_time.days/365.25)) + (cont_espp + cont_rsu)*delta_time.days/365.25
...
##        act_ret = random.gauss(avg_ret, sd_ret)
        ...
        timeline[row_cnt][0] = my_date
        timeline[row_cnt][1] = timeline[row_cnt][0] - jon_bd
        timeline[row_cnt][2] = timeline[row_cnt-1][1]*(1+act_ret) + 0 + cont_401k*((1+cpi)**(delta_time.days/365.25))
        timeline[row_cnt][3] = timeline[row_cnt-1][2]*(1+act_ret) + (cont_espp + cont_rsu - expenses)*((1+cpi)**(delta_time.days/365.25))
        timeline[row_cnt][4] = 0      #SS income
        timeline[row_cnt][5] = expenses      #Expenses
        timeline[row_cnt][6] = 0      #NQ Taxable Income
        timeline[row_cnt][7] = 0      #Q Taxable Income
        timeline[row_cnt][8] = 0      #Taxes
        timeline[row_cnt][9] = 0      #Healthcare
...
##    act_ret = random.gauss(avg_ret, sd_ret)
    ...
    timeline[row_cnt][2] = timeline[row_cnt-1][1]*((1+act_ret)**(frac_time.days/365.25)) + (0 + cont_401k)*frac_time.days/365.25
    timeline[row_cnt][3] = timeline[row_cnt-1][2]*((1+act_ret)**(frac_time.days/365.25)) + (cont_espp + cont_rsu - expenses)*frac_time.days/365.25
    timeline[row_cnt][4] = 0      #SS income
    timeline[row_cnt][5] = expenses*frac_time.days/365.25      #Expenses
    timeline[row_cnt][6] = 0      #NQ Taxable Income
    timeline[row_cnt][7] = 0      #Q Taxable Income
    timeline[row_cnt][8] = 0      #Taxes
    timeline[row_cnt][9] = 0      #Healthcare
...
##        act_ret = random.gauss(avg_ret, sd_ret)
        ...
        timeline[row_cnt][0] = my_date
        timeline[row_cnt][1] = timeline[row_cnt][0] - jon_bd
        timeline[row_cnt][2] = timeline[row_cnt-1][1]*(1+act_ret) + 0 + 0
        timeline[row_cnt][3] = timeline[row_cnt-1][2]*(1+act_ret) + 0 + 0 - expenses - taxes - health_care - liabilities
        liabilities = 0
        timeline[row_cnt][4] = 0      #SS income
        timeline[row_cnt][5] = expenses      #Expenses
        timeline[row_cnt][6] = timeline[row_cnt-1][2] * act_ret       #NQ Taxable Income
        timeline[row_cnt][7] = 0      #Q Taxable Income
        timeline[row_cnt][8] = taxes      #Taxes
        timeline[row_cnt][9] = health_care      #Healthcare
        row_cnt = row_cnt + 1
        my_date = my_date + datetime.timedelta(days = 365.25)
        delta_time = my_date - start_date
        expenses = proj_exp*((1+cpi)**(delta_time.days/365.25))
...
##    act_ret = random.gauss(avg_ret, sd_ret)
    ...
    timeline[row_cnt][2] = timeline[row_cnt-1][1]*((1+act_ret)**(frac_time.days/365.25)) + (0 + 0)*frac_time.days/365.25
    timeline[row_cnt][3] = timeline[row_cnt-1][2]*((1+act_ret)**(frac_time.days/365.25)) + (0 + 0 - expenses - taxes - health_care)*frac_time.days/365.25
    timeline[row_cnt][4] = 0      #SS income
    timeline[row_cnt][5] = expenses*frac_time.days/365.25      #Expenses
    timeline[row_cnt][6] = (timeline[row_cnt-1][2] * act_ret)*frac_time.days/365.25       #NQ Taxable Income
    timeline[row_cnt][7] = 0      #Q Taxable Income
    timeline[row_cnt][8] = taxes*frac_time.days/365.25      #Taxes
    timeline[row_cnt][9] = health_care*frac_time.days/365.25      #Healthcare
...
##        act_ret = random.gauss(avg_ret, sd_ret)
        ...
        timeline[row_cnt][1] = timeline[row_cnt][0] - jon_bd
        timeline[row_cnt][2] = timeline[row_cnt-1][1]*(1+act_ret) + 0 + 0
        timeline[row_cnt][3] = timeline[row_cnt-1][2]*(1+act_ret) + 0 + 0 - expenses - taxes - health_care + ss_income
        timeline[row_cnt][4] = ss_income      #SS income
        timeline[row_cnt][5] = expenses      #Expenses
        timeline[row_cnt][6] = timeline[row_cnt-1][2] * act_ret + ss_income*0.85       #NQ Taxable Income
        timeline[row_cnt][7] = 0      #Q Taxable Income
        timeline[row_cnt][8] = taxes      #Taxes
        timeline[row_cnt][9] = health_care      #Healthcare
        if timeline[row_cnt][2] < 0:
            back_add_taxes = timeline[row_cnt][1] + timeline[row_cnt][2] + taxes
            taxes = calc_taxes((expenses - ss_income*0.15))
            timeline[row_cnt][2] = back_add_taxes - taxes
            timeline[row_cnt][3] = 0
            timeline[row_cnt][6] = 0      #NQ Taxable Income
            timeline[row_cnt][7] = expenses - ss_income*0.15      #Q Taxable Income
            timeline[row_cnt][8] = taxes      #Taxes
            timeline[row_cnt][9] = health_care      #Healthcare
        row_cnt = row_cnt + 1
        my_date = my_date + datetime.timedelta(days = 365.25)
...
##    act_ret = random.gauss(avg_ret, sd_ret)
    ...
    timeline[row_cnt][2] = timeline[row_cnt-1][1]*((1+act_ret)**(delta_time.days/365.25)) - (expenses - taxes + ss_income)*delta_time.days/365.25
    row_cnt = row_cnt + 1
    timeline[row_cnt][0] = state3_end
    timeline[row_cnt][1] = timeline[row_cnt][0] - jon_bd
...
##                            act_ret = random.gauss(avg_ret, sd_ret)
                            ...
                            for my_row in range(0,next_row):
                                ...
                                plt_total.append(timeline[my_row][2] + timeline[my_row][3])
                            plt.figure(0)
                        ...
                        plt_total = []
                        for my_row in range(0,next_row):
                            plt_total.append(worst_tl[my_row][2] + worst_tl[my_row][3])
                        plt.figure(0)
                        ...
                        plt_dates = []
                        for my_row in range(0,next_row):
                            plt_total.append(nom_tl[my_row][2] + nom_tl[my_row][3])
                            plt_dates.append((date2num(timeline[my_row][0]) - date2num(jon_bd))/365.25)
                        plt.figure(0)
                        ...
                        plt_dates.append(58)
                        for my_row in range(0,next_row):
                            plt_total.append(nom_tl[my_row][2])
                            plt_dates.append((date2num(timeline[my_row][0]) - date2num(jon_bd))/365.25)
                        plt_total.append(0)
                        plt_dates.append(86)
                        plt.figure(0)
                    ...
                    header[0][0] = "Date"
                    header[0][1] = "Age"
                    header[0][2] = "Qual Total"
                    header[0][3] = "Non-Q Total"
                    header[0][4] = "SS Income"
                    header[0][5] = "Expenses"
                    header[0][6] = "NQ Taxable Income"
                    header[0][7] = "Q Taxable Income"
                    header[0][8] = "Taxes"
                    header[0][9] = "Healthcare"
                    header[0][10] = "Total Exp"
